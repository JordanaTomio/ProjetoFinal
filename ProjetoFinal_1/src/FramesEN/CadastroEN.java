...
public class CadastroEN extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroEN frame = new CadastroEN();
	...
	public CadastroEN() {
		setTitle("Register");
		setIconImage(Toolkit.getDefaultToolkit().getImage(CadastroEN.class.getResource("/imagens/3775232-16.png")));
		...
		JLabel lblCadastroDaInstituio = new JLabel("Registration Data");
		...
		JLabel lblNM_RAZAOSOCIAL = new JLabel("Social name:");
		...
		JLabel lblCIDADE = new JLabel("Telephone*:");
		...
		lblGenero.setBounds(332, 191, 81, 14);
		...
		JLabel lbldadosObrigatrios = new JLabel("*Obligatory data*");
		...
		Flor1_icon.setIcon(new ImageIcon(CadastroEN.class.getResource("/imagens/301738460207211(1).png")));
		Flor1_icon.setBounds(110, -43, 180, 146);
		contentPane.add(Flor1_icon);

		JLabel Flor2_icon = new JLabel("New label");
		Flor2_icon.setIcon(new ImageIcon(CadastroEN.class.getResource("/imagens/301738460207211(1).png")));
		...
		btnVoltar_icon.setIcon(new ImageIcon(CadastroEN.class.getResource("/imagens/3209260-128(1).png")));
		...
		btnMasculino = new JRadioButton("Male");
		...
		rdbtnOutros = new JRadioButton("Others");
		...
		Background_icon.setIcon(new ImageIcon(CadastroEN.class.getResource("/imagens/Background.jpg")));
