...
public class HotelEN extends JFrame {
	...
	public HotelEN() {
		...
		cachorro.setBounds(254, 223, 101, 23);
		...
		lblAlgumaObservao.setBounds(187, 253, 140, 28);
