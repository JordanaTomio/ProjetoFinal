...
public class PerfilEN<EntityManager> extends JFrame {
	...
	JRadioButton btnMasculino = new JRadioButton("Male");
	JRadioButton btnFeminino = new JRadioButton("Female");
	JRadioButton btnOutro = new JRadioButton("Others");
	...
	public PerfilEN() {
		setTitle("Profile");
		setIconImage(Toolkit.getDefaultToolkit().getImage(PerfilEN.class.getResource("/imagens/3775232-16.png")));
		...
		lblPerfil.setBounds(268, 11, 168, 81);
		contentPane.add(lblPerfil);

		JLabel lblNomePerfil = new JLabel("Name:");
		...
		JLabel lblTelefonePerfil = new JLabel("Telephone:");
		lblTelefonePerfil.setFont(new Font("Lucida Bright", Font.PLAIN, 15));
		lblTelefonePerfil.setBounds(20, 189, 87, 14);
		...
		JLabel lblEnderecoPerfil = new JLabel("Social Name:");
		...
		JLabel lblCepPerfil = new JLabel("ZIP Code");
		lblCepPerfil.setFont(new Font("Lucida Bright", Font.PLAIN, 14));
		lblCepPerfil.setBounds(357, 249, 63, 14);
		contentPane.add(lblCepPerfil);

		lblGeneroPerfil = new JLabel("Gender:");
		...
		btnMasculino.setBounds(417, 305, 93, 23);
		...
		btnOutro.setBounds(559, 304, 79, 23);
		...
		lblNewLabel.setIcon(new ImageIcon(PerfilEN.class.getResource("/imagens/3209260-128(1).png")));
		lblNewLabel.setBounds(11, 346, 46, 52);
		contentPane.add(lblNewLabel);

		background = new JLabel("New label");
		background.setIcon(new ImageIcon(PerfilEN.class.getResource("/imagens/Background.jpg")));
