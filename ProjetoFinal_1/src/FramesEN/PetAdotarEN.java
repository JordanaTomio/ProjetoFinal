...
public class PetAdotarEN extends JFrame {
	...
	JRadioButton btnMacho = new JRadioButton("Male");
	JRadioButton btnCao = new JRadioButton("Dog");
	JRadioButton btnGato = new JRadioButton("Cat");
	JRadioButton btnFemea = new JRadioButton("Female");
	JCheckBox vacinadodb = new JCheckBox("Vaccinated");
	JCheckBox castradodb = new JCheckBox("Neutered");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PetAdotarEN frame = new PetAdotarEN();
	...
	public PetAdotarEN() {
		setTitle("Adoption");
		setIconImage(Toolkit.getDefaultToolkit().getImage(PetAdotarEN.class.getResource("/imagens/3775232-16.png")));
		...
		vacinadodb.setBounds(25, 298, 100, 23);
		...
		btnProximo.setIcon(new ImageIcon(PetAdotarEN.class.getResource("/imagens/3847912-128(2).png")));
		...
		btnAnterior.setIcon(new ImageIcon(PetAdotarEN.class.getResource("/imagens/3847912-128(1).png")));
		...
		JButton btnAdotar = new JButton("Adopt");
		...
		Flor_icon.setIcon(new ImageIcon(PetAdotarEN.class.getResource("/imagens/302319657031211(1).png")));
		Flor_icon.setBounds(469, -27, 202, 198);
		contentPane.add(Flor_icon);

		JLabel btnVoltar_icon = new JLabel("");
		btnVoltar_icon.setIcon(new ImageIcon(PetAdotarEN.class.getResource("/imagens/3209260-128(1).png")));
		btnVoltar_icon.setBounds(14, 344, 46, 50);
		contentPane.add(btnVoltar_icon);

		JLabel Background_icon = new JLabel("New label");
		Background_icon.setIcon(new ImageIcon(PetAdotarEN.class.getResource("/imagens/Background.jpg")));
