...
public class PetShopMenuEN extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PetShopMenuEN frame = new PetShopMenuEN();
	...
	public PetShopMenuEN() {
		setTitle("Menu Pet Shop");
		setIconImage(Toolkit.getDefaultToolkit().getImage(PetShopMenuEN.class.getResource("/imagens/3775232-16.png")));
		...
		btnPedidos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultarPedidosEN frp = new ConsultarPedidosEN();
				frp.setVisible(true);
				dispose();
			}
		});
		...
		btnLoja.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConsultarProdutosEN crp = new ConsultarProdutosEN();
				crp.setVisible(true);
				dispose();
			}
		});
		...
		Flor_icon.setIcon(new ImageIcon(PetShopMenuEN.class.getResource("/imagens/302817012222211(1).png")));
		Flor_icon.setBounds(101, 41, 461, 318);
		contentPane.add(Flor_icon);
		
		JLabel Background_icon = new JLabel("New label");
		Background_icon.setIcon(new ImageIcon(PetShopMenuEN.class.getResource("/imagens/Background.jpg")));
