...
public class ConsultarClientesEN extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ConsultarClientesEN() {
		setTitle("Search Clients");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ConsultarClientesEN.class.getResource("/imagens/3775232-16.png")));
		...
		lblVoltar.setIcon(new ImageIcon(ConsultarClientesEN.class.getResource("/imagens/3209260-128(1).png")));
		lblVoltar.setBounds(8, 336, 50, 57);
		contentPane.add(lblVoltar);
		
		JLabel Backgroubd = new JLabel("New label");
		Backgroubd.setIcon(new ImageIcon(ConsultarClientesEN.class.getResource("/imagens/Background.jpg")));
