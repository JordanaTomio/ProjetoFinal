...
public class MenuEN extends JFrame {
	...
	public MenuEN() {
		setTitle("Menu");
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuEN.class.getResource("/imagens/3775232-16.png")));
		...
		btnAdocao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PetAdotarEN pea = new PetAdotarEN();
				pea.setVisible(true);
				dispose();
			}
		});
		...
		btnPetShop.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BanhoTosaEN bnt = new BanhoTosaEN();
				bnt.setVisible(true);
				dispose();
			}
		});
		...
		btnVet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ContatoVeterinarioEN cvt = new ContatoVeterinarioEN();
				cvt.setVisible(true);
				dispose();
			}
		});
		...
		JLabel lblLoja = new JLabel("Store");
		lblLoja.setForeground(new Color(0, 0, 0));
		lblLoja.setBounds(114, 244, 55, 22);
		...
		lblNewLabel_1.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/183189-128(1).png")));
		...
		label.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/Webp.net-resizeimage.png")));
		label.setBounds(258, 129, 138, 135);
		contentPane.add(label);
		
		JLabel lblVeterinrio = new JLabel("Veterinary");
		...
		lblNewLabel.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/Webp.net-resizeimage (1).png")));
		...
		label_1.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/Webp.net-resizeimage (2).png")));
		label_1.setBounds(463, 129, 138, 135);
		contentPane.add(label_1);
		
		
		JLabel cachorro = new JLabel("New label");
		cachorro.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/dog(1).png")));
		cachorro.setBounds(179, 97, 329, 315);
		contentPane.add(cachorro);
		
		
		JLabel lblManager = new JLabel("");
		lblManager.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/Adm menor.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/Hotel2.png")));
		...
		lblBackground.setIcon(new ImageIcon(MenuEN.class.getResource("/imagens/Background.jpg")));
