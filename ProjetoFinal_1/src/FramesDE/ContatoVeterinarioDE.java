...
public class ContatoVeterinarioDE extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ContatoVeterinarioDE frame = new ContatoVeterinarioDE();
	...
	public ContatoVeterinarioDE() {
		...
		label.setIcon(new ImageIcon(ContatoVeterinarioDE.class.getResource("/imagens/clip-art-veterinarian-2(1).png")));
		label.setBounds(477, 32, 137, 132);
		contentPane.add(label);
		
		JLabel lblNewLabel = new JLabel("Tier\u00E4rtzlich");
		lblNewLabel.setFont(new Font("Bauhaus 93", Font.PLAIN, 40));
		lblNewLabel.setBounds(198, 31, 231, 63);
		contentPane.add(lblNewLabel);
		
		JLabel lblVoltar = new JLabel("");
		lblVoltar.setIcon(new ImageIcon(ContatoVeterinarioDE.class.getResource("/imagens/3209260-128(1).png")));
		lblVoltar.setBounds(13, 327, 65, 76);
		contentPane.add(lblVoltar);
		
		JLabel lblBAIRRO = new JLabel("Schreibe sein Stadtteil");
		...
		txtBAIRRO.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				...
				String w = "";
				//-------------------------------------------------------------\\
				q = "SELECT NM_Veterinario Name, TL_Veterinario Telefonnummer, LC_Veterinario Strasse"
		...
		background.setIcon(new ImageIcon(ContatoVeterinarioDE.class.getResource("/imagens/Background.jpg")));
