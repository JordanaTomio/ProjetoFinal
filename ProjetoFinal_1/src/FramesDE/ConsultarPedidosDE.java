...
public class ConsultarPedidosDE extends JFrame {
	...
	public ConsultarPedidosDE() {
		...
		btnFinalizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new FinalizarPedidoDE().setVisible(true);
				dispose();
			}
		});
		...
		lblNewLabel.setIcon(new ImageIcon(ConsultarPedidosDE.class.getResource("/imagens/3209260-128(1).png")));
		...
		background.setIcon(new ImageIcon(ConsultarPedidosDE.class.getResource("/imagens/Background.jpg")));
