...
public class PerfilDE<EntityManager> extends JFrame {
	...
	public PerfilDE() {
		...
		JLabel lblTelefonePerfil = new JLabel("Telefonnummer:");
		lblTelefonePerfil.setFont(new Font("Lucida Bright", Font.PLAIN, 15));
		lblTelefonePerfil.setBounds(20, 189, 127, 14);
		...
		btnAlterar = new JButton("Tauschen");
		...
		lblNewLabel.setIcon(new ImageIcon(PerfilDE.class.getResource("/imagens/3209260-128(1).png")));
		lblNewLabel.setBounds(11, 346, 46, 52);
		contentPane.add(lblNewLabel);

		background = new JLabel("New label");
		background.setIcon(new ImageIcon(PerfilDE.class.getResource("/imagens/Background.jpg")));
