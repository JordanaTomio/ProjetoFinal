...
public class ConsultarProdutosDE extends JFrame {
	...
	public ConsultarProdutosDE() {
		...
		contentPane.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseMoved(MouseEvent e) {
				if (comboBox.getItemCount() > 0) {
					...
					try {
						if (rsValoTotal.next()) {
							valorTotalPedido += rsValoTotal.getDouble("Wert");
						}
		...
		lblNewLabel.setIcon(new ImageIcon(ConsultarProdutosDE.class.getResource("/imagens/3209260-128(1).png")));
		...
		background.setIcon(new ImageIcon(ConsultarProdutosDE.class.getResource("/imagens/Background.jpg")));
