...
public class PetShopMenuDE extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PetShopMenuDE frame = new PetShopMenuDE();
	...
	public PetShopMenuDE() {
		setTitle("Menu Pet Shop");
		setIconImage(Toolkit.getDefaultToolkit().getImage(PetShopMenuDE.class.getResource("/imagens/3775232-16.png")));
		...
		Perfil_icon.setIcon(new ImageIcon(PetShopMenuDE.class.getResource("/imagens/877017-128(1).png")));
		Perfil_icon.setBounds(461, 148, 140, 135);
		contentPane.add(Perfil_icon);
		
		JLabel btnVoltar_icon = new JLabel("New label");
		btnVoltar_icon.setIcon(new ImageIcon(PetShopMenuDE.class.getResource("/imagens/3209260-128(1).png")));
		btnVoltar_icon.setBounds(10, 345, 40, 45);
		contentPane.add(btnVoltar_icon);
		
		JLabel Produtos_icon = new JLabel("New label");
		Produtos_icon.setIcon(new ImageIcon(PetShopMenuDE.class.getResource("/imagens/877020-128-2-.png")));
		Produtos_icon.setBounds(248, 148, 140, 135);
		contentPane.add(Produtos_icon);
		
		JLabel Pedidos_icon = new JLabel("New label");
		Pedidos_icon.setIcon(new ImageIcon(PetShopMenuDE.class.getResource("/imagens/877015-128-2-.png")));
		...
		Flor_icon.setIcon(new ImageIcon(PetShopMenuDE.class.getResource("/imagens/302817012222211(1).png")));
